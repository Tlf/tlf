...
int tune_seconds = TUNE_UP;		// for back-ward compatibility, keep old default
...
int callinput(void) {
	...
	switch (x) {
		...
		tune();	// moved to function upon suggest/HA5CQZ to help readibility, too many indenting levels
